...
const TOWER_SPRITE_PATHS = {
  ...
  hunter: "/assets/towers/level2/hunter.png",
  crossbowman: "/assets/towers/level2/musketeer.png",
  bombardier: "/assets/towers/level2/mortair.png",
  ice_pillar: "/assets/towers/level2/frozen_post.png",
  poison_vine: "/assets/towers/level2/poisonous_vine.png",
  discharger: "/assets/towers/level2/discharge.png",
  war_drum: "/assets/towers/level2/battle_drum.png",
  sniper: "/assets/towers/level3/sniper.png",
  executioner: "/assets/towers/level3/executor.png",
  multicannon: "/assets/towers/level3/multibarrel.png",
  snow_storm: "/assets/towers/level3/snowstorm.png",
  plague_flower: "/assets/towers/level3/plague%20flower.png",
  storm_pillar: "/assets/towers/level3/thunderer.png",
  power_totem: "/assets/towers/level3/totemofpower.png",
  sharpshooter: "/assets/towers/level4/accurateshooter.png",
  punisher: "/assets/towers/level4/punisher.png",
  stardrop: "/assets/towers/level4/starfall.png",
  absolute_cold: "/assets/towers/level4/absolutecold.png",
  black_ivy: "/assets/towers/level4/blackivy.png",
  lightning_lord: "/assets/towers/level4/lighrningbringer.png",
  war_banner: "/assets/towers/level4/warbanner.png",
  ghost_archer: "/assets/towers/level5/shadowdhutter.png",
  titan_slayer: "/assets/towers/level5/titankiller.png",
  cataclysm: "/assets/towers/level5/cataklism.png",
  ice_throne: "/assets/towers/level5/icethrone.png",
  plague_lord: "/assets/towers/level5/plaguemaster.png",
  sky_storm: "/assets/towers/level5/skystorm.png",
  ancient_totem: "/assets/towers/level5/ancient%20totem.png",
...
const MYTHIC_TOWERS = [
  ...
  makeTower({ id: "plague_master", family: "plague_master", level: 6, tier: "Уровень 6", name: "ПОВЕЛИТЕЛЬ ЧУМЫ", attributeType: "Интеллект", attackType: "Магическая", pattern: "single", rangeCells: 4.5, cooldown: 0.6, baseDamage: 450, speedBurstChance: 0.30, speedBurstBoost: 0.80, speedBurstDuration: 3, shotColor: "#d7ff96", bodyColor: "#417d31", trimColor: "#fbffd8", visual: "toxin", talent: "30% шанс ускориться на 80% на 3 сек.", description: "Быстрая магическая одиночная башня с проком разгона." }),
...
function drawTowerImageSprite(tower) {
  ...
  const tierScale = tower.level === 1 ? 2.2 : 1;
